...
function addBackToTop() {
  ...
  b = i.innerHTML,
  v = void 0 === b ? '<svg viewBox="0 0 24 24" alt="Scroll to top of page"><path d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z" alt="Scroll to top of page"></path></svg>' : b,
  f = i.onClickScrollTo,
  x = void 0 === f ? 0 : f,
  w = i.scrollContainer,
  ...
  }(A ? window : g).addEventListener('scroll', S),
  S()
}
