...
Both online and offline, privacy and <a href="https://ssd.eff.org/" target="_blank">self-defense against surveillance<i class="fas fa-external-link-alt"></i></a> are basic human rights. This website is designed to ensure user privacy, data protection, and data economy. No data (e.g., IP addresses, cookies, or browser fingerprints) is ever collected, transmitted, stored, or used in any form to identify or track the visitors of this website, which observes a strict policy of
  <ul class="fa-ul">
    ...
    <li><span class="fa-li"><i class="fab fa-html5"></i></span><b>valid</b> <a href="https://validator.w3.org/nu/?doc=https%3A%2F%2Fsteffenwoell.github.io%2F" target="_blank">HTML<i class="fas fa-external-link-alt"></i></a></li>
    <li><span class="fa-li"><i class="fab fa-css3-alt"></i></span><b>valid</b> <a href="https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2Fsteffenwoell.github.io%2F&profile=css3svg&usermedium=all&warning=1&vextwarning=&lang=en" target="_blank">CSS<i class="fas fa-external-link-alt"></i></a></li>
